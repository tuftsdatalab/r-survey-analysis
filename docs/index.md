...
An intermediate R workshop that focuses on performing statistical analysis on survey data and covers the following:

- The oddities of working with **survey data**
- Reading **proprietary-format** data files
- **Recoding** and **constructing** variables
